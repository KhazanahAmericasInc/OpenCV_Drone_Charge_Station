...
KIx, KIy, KIz, KIangle = 0, 0, 0.05, 0
...
while True:
    ...
    if framesWithoutDrone >= 6000:
        ...
        while (k < 10):
            command = "%i,%i,%i,%i,2000" % (throttle_off, aileron_middle, elevator_middle, rudder_middle)
            command = command + "\n"
    ...
    command = "%i,%i,%i,%i,2000" % (throttleCommand, aileronCommand, elevatorCommand, rudderCommand)
